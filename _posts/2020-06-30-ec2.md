...
1. Termination Protection is turned off by default, which means by default, you cannot terminal an EC2 Instance.
...
- create a copy of the snapshot and select the encrypt opinion
