...
During an exam, if you need xx IPs for EC2 instances, when doing your CIDR block, remember to minus 5 (round up)
...
- NACL are like are firewall that controls traffic from and to subnet
...
- A network ACL can be associated with N subnets, but 1 subnet can only be associated with 1 ACL.
